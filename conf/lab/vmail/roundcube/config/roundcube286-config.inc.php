...
$config['plugins'] = array('archive','authres_status','contextmenu','custom_from','filesystem_attachments','forward','hide_blockquote','html5_notifier','identity_select','jqueryui','keyboard_shortcuts','legacy_browser','markasjunk2','newmail_notifier','rememberme','vcard_attachments','virtuser_file','zipdownload');
// Omitted: 'password',
